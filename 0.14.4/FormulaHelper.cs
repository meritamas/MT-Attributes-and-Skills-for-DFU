...
* Breton:   STR -1 END -1  INT +2    WIL +2  SPEED -1  AGI -1         *                 // please note Breton stats changedas of 2-MAR-2022
...
* */
        ...
        public static int[,] RaceMaxStats = new int[8, 8] {
            { MinusOneValue, PlusTwoValue, PlusTwoValue,  MinusOneValue, MinusOneValue, ZeroValue, MinusOneValue,    ZeroValue },    // Breton  // please note Breton stats changedas of 2-MAR-2022
        ...
        {       // MT changed - note that now it is hard-coded while in the original version it was moddable 
            ...
            return (int)(skillAdvancementMultiplier * careerAdvancementMultiplier * statSkillLevelModifier * ((4.25 / 3) * slowSkillLevelModifier + (23 / 3) * fastSkillLevelModifier)) + 1;    // please note: 1/3 coeficient added to incorporate divine blessing - ability to develop skills fast (2-MAR-2022)
        }
